...
class EpiconIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.epicon.in/documentaries/air-battle-of-srinagar',
               'info_dict': {'id': 'air-battle-of-srinagar',
                             'ext': 'mp4',
...
class EpiconSeriesIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        entries = [
            self.url_result(
                f'https://www.epicon.in/{episode}',
                EpiconIE) for episode in episodes]
