...
class TMZIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.tmz.com/videos/0-cegprt2p/',
               'info_dict': {'id': 'http://www.tmz.com/videos/0-cegprt2p/',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.tmz.com/videos/071119-chris-morgan-women-4590005-0-zcsejvcr/',
               'info_dict': {'id': 'https://www.tmz.com/videos/071119-chris-morgan-women-4590005-0-zcsejvcr/',
                             'ext': 'mp4',
              ...
              {'url': 'http://www.tmz.com/2015/04/19/bobby-brown-bobbi-kristina-awake-video-concert',
               ...
               'info_dict': {'id': 'http://www.tmz.com/2015/04/19/bobby-brown-bobbi-kristina-awake-video-concert',
                             'ext': 'mp4',
              ...
              {'url': 'http://www.tmz.com/2015/09/19/patti-labelle-concert-fan-stripping-kicked-out-nicki-minaj/',
               'info_dict': {'id': 'http://www.tmz.com/2015/09/19/patti-labelle-concert-fan-stripping-kicked-out-nicki-minaj/',
                             'ext': 'mp4',
              ...
              {'url': 'http://www.tmz.com/2016/01/28/adam-silver-sting-drake-blake-griffin/',
               'info_dict': {'id': 'http://www.tmz.com/2016/01/28/adam-silver-sting-drake-blake-griffin/',
                             'ext': 'mp4',
              ...
              {'url': 'http://www.tmz.com/2016/10/27/donald-trump-star-vandal-arrested-james-otis/',
               'info_dict': {'id': 'http://www.tmz.com/2016/10/27/donald-trump-star-vandal-arrested-james-otis/',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.tmz.com/videos/2020-10-31-103120-beverly-hills-protest-4878209/',
               'info_dict': {'id': 'https://www.tmz.com/videos/2020-10-31-103120-beverly-hills-protest-4878209/',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.tmz.com/2020/11/19/conor-mcgregor-dustin-poirier-contract-fight-ufc-257-fight-island/',
               'info_dict': {'id': '1329448013937471491',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        if not jsonld or 'url' not in jsonld:
            ...
            # see
            # https://developers.google.com/youtube/iframe_api_reference#Video_Queueing_Functions
            match_obj = re.search(
