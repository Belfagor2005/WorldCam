...
class TvwIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tvw.org/video/billy-frank-jr-statue-maquette-unveiling-ceremony-2024011211/',
               'md5': '9ceb94fe2bb7fd726f74f16356825703',
               'info_dict': {'id': '2024011211',
                             'ext': 'mp4',
...
class TvwNewsIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        video_ids = traverse_obj(
            webpage, ({
                find_elements(
                    cls='invintus-player', html=True)}, ..., {extract_attributes}, 'data-eventid'))
