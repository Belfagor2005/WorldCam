        ...
        for device_type, browser in [
            ...
            if video := traverse_obj(dinfo, ('video', {dict})):
                ...
                if code == 2009:
                    ...
                    # 2019: L'accès à cette vidéo est incompatible avec votre
                    # configuration. (DRM-only)
                    drm_formats = True
                    continue
                self.report_warning(
...
class FranceTVSiteIE(FranceTVBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            # old: ec217ecc-0733-48cf-ac06-af1347b849d1
            'id': 'b2cf9fd8-e971-4757-8651-848f2772df61',
            'ext': 'mp4',
            'title': '13h15, le dimanche... - Les mystères de Jésus',
            'timestamp': 1502623500,
            'duration': 2580,
