...
class MGTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.mgtv.com/v/1/290525/f/3116640.html',
               'info_dict': {'id': '3116640',
                             'ext': 'mp4',
                             'title': '我是歌手 第四季',
    ...
    def _real_extract(self, url):
        ...
        for idx, stream in enumerate(traverse_obj(
                stream_data, ('stream', lambda _, v: v['url']))):
