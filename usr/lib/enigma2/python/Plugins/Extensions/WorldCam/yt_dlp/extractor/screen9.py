...
class Screen9IE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://api.screen9.com/embed/8kTNEjvoXGM33dmWwF0uDA',
               'md5': 'd60d23f8980583b930724b01fa6ddb41',
               'info_dict': {'id': '8kTNEjvoXGM33dmWwF0uDA',
                             'ext': 'mp4',
              ...
              {'url': 'https://folkhogskolekanalen.screen9.tv/media/gy35PKLHe-5K29RYHga2bw/ett-starkare-samhalle-en-snabbguide-om-sveriges-folkhogskolor',
               ...
               'info_dict': {'id': 'gy35PKLHe-5K29RYHga2bw',
                             'ext': 'mp4',
              ...
              {'url': 'https://play.su.se/media/H1YA0EYNCxiesrSU1kaRBQ/baltic-breakfast',
               ...
               'info_dict': {'id': 'H1YA0EYNCxiesrSU1kaRBQ',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        formats, subtitles = self._extract_m3u8_formats_and_subtitles(
            ...
            video_id, ext='mp4')
        formats.append({'url': traverse_obj(config,
                                            ('src',
                                             lambda _,
                                             v: v['type'] == 'video/mp4',
                                             'src'),
