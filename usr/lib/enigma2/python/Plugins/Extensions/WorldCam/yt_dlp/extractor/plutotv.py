...
class PlutoTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://pluto.tv/on-demand/series/i-love-money/season/2/episode/its-in-the-cards-2009-2-3',
               'md5': 'ebcdd8ed89aaace9df37924f722fd9bd',
               'info_dict': {'id': '5de6c598e9379ae4912df0a8',
                             'ext': 'mp4',
              ...
              {'url': 'https://pluto.tv/on-demand/series/i-love-money/season/1/',
               'playlist_count': 11,
               'info_dict': {'id': '5de6c582e9379ae4912dedbd',
              ...
              {'url': 'https://pluto.tv/on-demand/movies/arrival-2015-1-1',
               ...
               'info_dict': {'id': '5e83ac701fa6a9001bb9df24',
                             'ext': 'mp4',
                             'title': 'Arrival',
              ...
              {'url': 'https://pluto.tv/en/on-demand/movies/attack-of-the-killer-tomatoes-1977-1-1-ptv1',
               ...
               'info_dict': {'id': '5b190c7bb0875c36c90c29c4',
                             'ext': 'mp4',
    ...
    def _get_video_info(self, video_json, slug, series_name=None):
        ...
        formats, subtitles = [], {}
        for video_url in try_get(
                video_json,
                lambda x: x['stitched']['urls'],
                list) or []:
    ...
    def _real_extract(self, url):
        ...
        if mobj['video_type'] == 'series':
            ...
            season_number, episode_slug = mobj.get(
                'season_number'), mobj.get('episode_slug')
            ...
            for season in video_json['seasons']:
                ...
                for episode in season['episodes']:
                    if episode_slug is not None and episode_slug != episode.get(
                            'slug'):
                        continue
                    videos.append(
            ...
            return self.playlist_result(
                videos, playlist_id=video_json.get(
                    '_id', info_slug), playlist_title=playlist_title)
