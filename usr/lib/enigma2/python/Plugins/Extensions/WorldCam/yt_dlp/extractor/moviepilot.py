...
class MoviepilotIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.moviepilot.de/movies/interstellar-2/',
               'info_dict': {'id': 'x7xdpkk',
              ...
              {'url': 'https://www.moviepilot.de/movies/der-geiger-von-florenz/trailer',
               'info_dict': {'id': 'der-geiger-von-florenz',
    ...
    def _real_extract(self, url):
        ...
        clip = self._search_nextjs_data(webpage, video_id)[
