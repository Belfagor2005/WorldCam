...
class SharePointIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://lut-my.sharepoint.com/:v:/g/personal/juha_eerola_student_lab_fi/EUrAmrktb4ZMhUcY9J2PqMEBD_9x_l0DyYWVgAvp-TTOMw?e=ZpQOOw',
               ...
               'info_dict': {'id': '01EQRS7EKKYCNLSLLPQZGIKRYY6SOY7KGB',
    ...
    def _real_extract(self, url):
        ...
        if urllib.parse.urlparse(
                urlh.url).hostname == 'login.microsoftonline.com':
        ...
        # Web player adds more params to the format URLs but we still get all
        # formats without them
        formats = self._extract_mpd_formats(
            base_media_url, video_id, mpd_id='dash', query={
                'format': 'dash'}, fatal=False)
