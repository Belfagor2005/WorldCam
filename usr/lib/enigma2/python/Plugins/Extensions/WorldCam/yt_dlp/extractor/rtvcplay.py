...
class RTVCPlayBaseIE(InfoExtractor):
    ...
    def _extract_formats_and_subtitles_player_config(
        ...
        for source in traverse_obj(
            player_config, ('sources', ..., lambda _, v: url_or_none(
                v['url']))):
            ext = mimetype2ext(
                source.get('mimetype'),
                default=determine_ext(
                    source['url']))
            if ext == 'm3u8':
...
class RTVCPlayIE(RTVCPlayBaseIE):
    _VALID_URL = RTVCPlayBaseIE._BASE_VALID_URL + \
        r'/(?P<category>(?!embed)[^/]+)/(?:[^?#]+/)?(?P<id>[\w-]+)'

    _TESTS = [{'url': 'https://www.rtvcplay.co/en-vivo/canal-institucional',
               'info_dict': {'id': 'canal-institucional',
              ...
              {'url': 'https://www.rtvcplay.co/competencias-basicas-ciudadanas-y-socioemocionales/profe-en-tu-casa/james-regresa-clases-28022022',
               ...
               'info_dict': {'id': 'james-regresa-clases-28022022',
              ...
              {'url': 'https://www.rtvcplay.co/peliculas-documentales/llinas-el-cerebro-y-el-universo',
               'info_dict': {'id': 'llinas-el-cerebro-y-el-universo',
              ...
              {'url': 'https://www.rtvcplay.co/series-al-oido/relato-de-un-naufrago-una-travesia-del-periodismo-a-la-literatura',
               'info_dict': {'id': 'relato-de-un-naufrago-una-travesia-del-periodismo-a-la-literatura',
