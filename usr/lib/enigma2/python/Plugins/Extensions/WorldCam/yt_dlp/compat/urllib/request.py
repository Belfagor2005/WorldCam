...
if os.name == 'nt':
    ...
    # 2:
    # https://github.com/python/cpython/blob/51f1ae5ceb0673316c4e4b0175384e892e33cc6e/Lib/urllib/request.py#L2683-L2698
    import sys
    ...
    def getproxies_registry_patched():
        ...
        if sys.version_info < (
                3,
                10,
                5):  # https://docs.python.org/3.10/whatsnew/changelog.html#python-3-10-5-final
