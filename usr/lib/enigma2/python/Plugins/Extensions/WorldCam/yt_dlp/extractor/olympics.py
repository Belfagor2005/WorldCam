...
class OlympicsReplayIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://olympics.com/fr/video/men-s-109kg-group-a-weightlifting-tokyo-2020-replays',
              ...
              {'url': 'https://olympics.com/en/original-series/episode/b-boys-and-b-girls-take-the-spotlight-breaking-life-road-to-paris-2024',
               'info_dict': {'id': '32633650-c5ee-4280-8b94-fb6defb6a9b5',
                             'ext': 'mp4',
              ...
              {'url': 'https://olympics.com/en/paris-2024/videos/men-s-preliminaries-gbr-esp-ned-rsa-hockey-olympic-games-paris-2024',
               'info_dict': {'id': '3d96db23-8eee-4b7c-8ef5-488a0361026c',
                             'ext': 'mp4',
              ...
              {'url': 'https://olympics.com/en/paris-2024/videos/dnp-suni-lee-i-have-goals-and-i-have-expectations-for-myself-but-i-also-am-trying-to-give-myself-grace',
               'info_dict': {'id': 'a42f37ab-8a74-41d0-a7d9-af27b7b02a90',
                             'ext': 'mp4',
    ...
    def _extract_from_nextjs_data(self, webpage, video_id):
        ...
        m3u8_url = traverse_obj(
            data, ('videoUrl', {url_or_none})) or data['streamUrl']
        ...
        try:
            ...
            if isinstance(
                    e.cause,
                    HTTPError) and 'georestricted' in e.cause.msg:
                self.raise_geo_restricted(countries=geo_countries)
            raise
    ...
    def _real_extract(self, url):
        ...
        if not thumbnails_list:
            ...
            thumbnails_list = thumbnails_list.replace(
                '[', '').replace(']', '').split(',')
            thumbnails_list = [thumbnail.strip()
        ...
        for thumbnail in thumbnails_list:
            ...
            width_a, height_a, width = int_or_none(
                width_a), int_or_none(height_a), int_or_none(width)
            thumbnails.append({'url': thumbnail, 'width': width, 'height': int_or_none(
