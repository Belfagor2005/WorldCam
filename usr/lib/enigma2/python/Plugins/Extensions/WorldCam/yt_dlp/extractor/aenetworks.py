...
class AENetworksIE(AENetworksBaseIE):
    ...
    _TESTS = [{'url': 'http://www.history.com/shows/mountain-men/season-1/episode-1',
               'info_dict': {'id': '22253814',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        domain, canonical, url_type, extra = self._match_valid_url(
            url).group('domain', 'id', 'type', 'extra')
