...
class PanoptoIE(PanoptoBaseIE):
    ...
    _TESTS = [{
        ...
        # Does not allow normal Viewer.aspx. AUDIO livestream has no url, so
        # should be skipped and only give one stream.
        ...
        # On Panopto there are two subs: "Default" and en-US. en-US is blank
