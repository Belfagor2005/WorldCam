...
class MedalTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://medal.tv/games/valorant/clips/jTBFnLKdLy15K',
               'md5': '03e4911fdcf7fce563090705c2e79267',
               'info_dict': {'id': 'jTBFnLKdLy15K',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        author = traverse_obj(
            hydration_data, ('profiles', ...), get_all=False) or {}
