...
class ParamountPlusIE(CBSBaseIE):
    ...
    _TESTS = [{'url': 'https://www.paramountplus.com/shows/video/Oe44g5_NrlgiZE3aQVONleD6vXc8kP0k/',
              ...
              {'url': 'https://www.paramountplus.com/shows/video/6hSWYWRrR9EUTz7IEe5fJKBhYvSUfexd/',
               'info_dict': {'id': '6hSWYWRrR9EUTz7IEe5fJKBhYvSUfexd',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.paramountplus.com/movies/video/vM2vm0kE6vsS2U41VhMRKTOVHyQAr6pC/',
               'info_dict': {'id': 'vM2vm0kE6vsS2U41VhMRKTOVHyQAr6pC',
                             'ext': 'mp4',
                             'title': 'Daddy\'s Home',
    ...
    def _extract_video_info(self, content_id, mpx_acc=2198311517):
        ...
        asset_types = {
            item.get('assetType'): {
                'format': 'SMIL',
                # '+none' specifies ProtectionScheme (no DRM)
