...
class RedCDNLivxIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://r.dcs.redcdn.pl/livedash/o2/senat/ENC02/channel.livx?indexMode=true&startTime=638272860000&stopTime=638292544000',
               'info_dict': {'id': 'ENC02-638272860000-638292544000',
                             'ext': 'mp4',
                             'title': 'ENC02',
                             'duration': 19683.982,
              ...
              {'url': 'https://r.dcs.redcdn.pl/livedash/o2/sejm/ENC18/live.livx?indexMode=true&startTime=722333096000&stopTime=722335562000',
               'info_dict': {'id': 'ENC18-722333096000-722335562000',
                             'ext': 'mp4',
                             'title': 'ENC18',
                             'duration': 2463.995,
                             'live_status': 'was_live',
              ...
              {'url': 'https://r.dcs.redcdn.pl/livehls/o2/sportevolution/live/triathlon2018/warsaw.livx/playlist.m3u8?startTime=550305000000&stopTime=550327620000',
               'info_dict': {'id': 'triathlon2018-warsaw-550305000000-550327620000',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        def livx_mode(mode):
            ...
            return update_url_query(
                f'https://r.dcs.redcdn.pl/{mode}/o2/{tenant}/{path}.livx{suffix}', file_qs)
        ...
        formats = []
        # downloading the manifest separately here instead of
        # _extract_ism_formats to also get some stream metadata
        ...
        time_scale = traverse_obj(
            ism_doc, ('@TimeScale', {int_or_none})) or 10000000
