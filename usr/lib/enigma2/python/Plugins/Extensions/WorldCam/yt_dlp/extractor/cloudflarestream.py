...
class CloudflareStreamIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://embed.cloudflarestream.com/embed/we4g.fla9.latest.js?video=31c9291ab41fac05471db4e73aa11717',
               'info_dict': {'id': '31c9291ab41fac05471db4e73aa11717',
                             'ext': 'mp4',
              ...
              {'url': 'https://watch.cloudflarestream.com/embed/sdk-iframe-integration.fla9.latest.js?video=0e8e040aec776862e1d632a699edf59e',
               'info_dict': {'id': '0e8e040aec776862e1d632a699edf59e',
                             'ext': 'mp4',
