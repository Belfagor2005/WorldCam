...
class RottenTomatoesIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.rottentomatoes.com/m/toy_story_3/trailers/11028566/',
               'info_dict': {'id': '11028566',
                             'ext': 'mp4',
                             'title': 'Toy Story 3',
              ...
              {'url': 'http://www.rottentomatoes.com/m/toy_story_3',
               'info_dict': {'id': 'toy_story_3',
                             'title': 'Toy Story 3',
                             },
               'playlist_mincount': 4,
               },
              {'url': 'http://www.rottentomatoes.com/m/toy_story_3/trailers',
               'info_dict': {'id': 'toy_story_3-trailers',
                             },
               'playlist_mincount': 5,
               }]
    ...
    def _real_extract(self, url):
        playlist_id, trailers, video_id = self._match_valid_url(
            url).group('playlist', 'tr', 'id')
