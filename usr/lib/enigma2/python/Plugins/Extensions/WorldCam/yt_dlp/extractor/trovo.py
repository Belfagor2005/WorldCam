...
class TrovoBaseIE(InfoExtractor):
    ...
    def _extract_streamer_info(self, data):
        ...
        return {
            'uploader': streamer_info.get('nickName'), 'uploader_id': str_or_none(
                streamer_info.get('uid')), 'uploader_url': format_field(
...
class TrovoIE(TrovoBaseIE):
    ...
    _TESTS = [{'url': 'https://trovo.live/Exsl',
               'only_matching': True,
               },
              ...
              {'url': 'https://trovo.live/s/zijo987/208251706',
               'info_dict': {'id': '104125853_104125853_1656439572',
                             'ext': 'flv',
...
class TrovoVodIE(TrovoBaseIE):
    ...
    _TESTS = [{'url': 'https://trovo.live/clip/lc-5285890818705062210?ltab=videos',
               'params': {'getcomments': True},
               'info_dict': {'id': 'lc-5285890818705062210',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        if not vod_detail_info:
            raise ExtractorError(
                'This video not found or not available anymore',
                expected=True)
...
class TrovoChannelBaseIE(TrovoBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(
            self._entries(spacename),
            playlist_id=spacename)
