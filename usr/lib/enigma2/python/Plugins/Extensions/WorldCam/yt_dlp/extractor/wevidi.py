...
class WeVidiIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://wevidi.net/watch/2th7UO5F4KV',
               'md5': 'b913d1ff5bbad499e2c7ef4aa6d829d7',
               'info_dict': {'id': '2th7UO5F4KV',
                             'ext': 'mp4',
    ...
    def _extract_formats(self, wvplayer_props):
        # Taken from WeVidi player JS:
        # https://wevidi.net/layouts/default/static/player.min.js
        resolution_map = {
            1: 144,
            2: 240,
            3: 360,
        ...
        return {
            ...
            'uploader': clean_html(
                get_element_by_class(
                    ...
                    webpage)),
            'formats': list(
                self._extract_formats(wvplayer_props)),
            'thumbnail': self._og_search_thumbnail(webpage),
            'duration': float_or_none(
                wvplayer_props.get('duration')),
        }
