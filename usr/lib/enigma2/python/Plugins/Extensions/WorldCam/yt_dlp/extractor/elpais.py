...
class ElPaisIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://blogs.elpais.com/la-voz-de-inaki/2014/02/tiempo-nuevo-recetas-viejas.html',
               'md5': '98406f301f19562170ec071b83433d55',
               'info_dict': {'id': 'tiempo-nuevo-recetas-viejas',
                             'ext': 'mp4',
              ...
              {'url': 'http://elcomidista.elpais.com/elcomidista/2016/02/24/articulo/1456340311_668921.html#?id_externo_nwl=newsletter_diaria20160303t',
               ...
               'info_dict': {'id': '1456340311_668921',
                             'ext': 'mp4',
              ...
              {'url': 'http://elpais.com/elpais/2017/01/26/ciencia/1485456786_417876.html',
               ...
               'info_dict': {'id': '1485456786_417876',
                             'ext': 'mp4',
              ...
              {'url': 'http://epv.elpais.com/epv/2017/02/14/programa_la_voz_de_inaki/1487062137_075943.html',
               'info_dict': {'id': '1487062137_075943',
                             'ext': 'mp4',
                             'title': 'Disyuntivas',
    ...
    def _real_extract(self, url):
        ...
        thumbnail = (
            None if thumbnail_suffix is None else prefix +
            thumbnail_suffix) or self._og_search_thumbnail(webpage)
