...
class LastFMPlaylistBaseIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_from_matches(self._entries(
            url, playlist_id), playlist_id, ie='Youtube')
...
class LastFMIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.last.fm/music/Oasis/_/Wonderwall',
               'md5': '9c4a70c2e84c03d54fe24229b9e13b7b',
               'info_dict': {'id': '6hzrDeceEKc',
                             'ext': 'mp4',
