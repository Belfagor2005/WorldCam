...
class JTBCIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tv.jtbc.co.kr/replay/pr10011629/pm10067930/ep20216321/view',
               'md5': 'e6ade71d8c8685bbfd6e6ce4167c6a6c',
               'info_dict': {'id': 'VO10721192',
    ...
    def _real_extract(self, url):
        ...
        for sub in traverse_obj(
            ...
            subtitles.setdefault(sub.get('label', 'und'),
                                 []).append({'url': sub['file']})
    ...
    def _real_extract(self, url):
        ...
        entries = [
            self.url_result(
                ...
                JTBCIE,
                video_id) for video_id in traverse_obj(
                vod_list,
                ('programReplayVodList',
                 ...,
                 'episodeId'))]
