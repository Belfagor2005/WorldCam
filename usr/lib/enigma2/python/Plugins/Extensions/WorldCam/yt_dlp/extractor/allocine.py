...
class AllocineIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.allocine.fr/article/fichearticle_gen_carticle=18635087.html',
               'md5': '0c9fcf59a841f65635fa300ac43d8269',
               'info_dict': {'id': '19546517',
                             'display_id': '18635087',
                             'ext': 'mp4',
