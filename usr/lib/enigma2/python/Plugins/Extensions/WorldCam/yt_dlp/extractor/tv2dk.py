...
class TV2DKIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.tvsyd.dk/nyheder/28-10-2019/1930/1930-28-okt-2019?autoplay=1#player',
              ...
              {'url': 'https://www.tvsyd.dk/haderslev/x-factor-brodre-fulde-af-selvtillid-er-igen-hjemme-hos-mor-vores-diagnoser-har-vaeret-en-fordel',
               'info_dict': {'id': 'x-factor-brodre-fulde-af-selvtillid-er-igen-hjemme-hos-mor-vores-diagnoser-har-vaeret-en-fordel',
                             },
               'playlist_count': 2,
               },
              {'url': 'https://www.tv2ostjylland.dk/aarhus/dom-kan-fa-alvorlige-konsekvenser',
               'info_dict': {'id': 'dom-kan-fa-alvorlige-konsekvenser',
                             },
               'playlist_count': 3,
               },
    ...
    def _real_extract(self, url):
        ...
        search_space = traverse_obj(webpage,
                                    {find_element(tag='article')}) or webpage
        ...
        return self.playlist_from_matches(
            player_ids,
            video_id,
            getter=lambda x: f'jwplatform:{x}',
            ie=JWPlatformIE)
