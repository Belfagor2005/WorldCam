...
class YleAreenaIE(InfoExtractor):
    ...
    _GEO_COUNTRIES = ['FI']
    _TESTS = [{'url': 'https://areena.yle.fi/1-4371942',
               'md5': 'd87e9a1e74e67e009990ddd413e426b4',
               'info_dict': {'id': '1-4371942',
                             'ext': 'mp4',
                             'title': 'Pouchit',
    ...
    def _real_extract(self, url):
        video_id, is_podcast = self._match_valid_url(
            url).group('id', 'podcast')
        json_ld = self._search_json_ld(
            self._download_webpage(
                url, video_id), video_id, default={})
        ...
        if is_podcast and traverse_obj(
            ...
            metadata = video_data['ongoing_ondemand']
        # XXX: Has all externally-hosted Kaltura content been moved to native
        # hosting?
