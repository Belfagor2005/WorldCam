...
class BlueskyIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://bsky.app/profile/blu3blue.bsky.social/post/3l4omssdl632g',
               'md5': '375539c1930ab05d15585ed772ab54fd',
               'info_dict': {'id': '3l4omssdl632g',
                             'ext': 'mp4',
              ...
              {'url': 'https://bsky.app/profile/purpleicetea.bsky.social/post/3l7gv55dc2o2w',
               'info_dict': {'id': '3l7gv55dc2o2w',
                             },
               'playlist': [{'info_dict': {'id': '3l7gv55dc2o2w',
                                           'ext': 'mp4',
                                           'upload_date': '20241026',
    ...
    def _get_service_endpoint(self, did, video_id):
        ...
        return traverse_obj(
            ...
            ('service',
             lambda _,
             x: x['type'] == 'AtprotoPersonalDataServer',
                'serviceEndpoint',
                {url_or_none},
                any)) or 'https://bsky.social'
        ...
        if did and video_cid:
            ...
            for sub_data in traverse_obj(
                ...
                subtitles.setdefault(
                    sub_data.get('lang') or 'und', []).append(
                    {
                        'url': update_url_query(
                            self._BLOB_URL_TMPL.format(endpoint), {
                                'did': did, 'cid': sub_data['file']['ref']['$link']}), 'ext': traverse_obj(
