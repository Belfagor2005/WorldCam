...
class MirrorCoUKIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.mirror.co.uk/tv/tv-news/love-island-fans-baffled-after-27163139',
               'info_dict': {'id': 'voyyS7SV',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        data = self._search_json(
            ...
            'data',
            display_id,
            transform_source=unescapeHTML)['videoData']
