...
class BeatBumpVideoIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return self.url_result(
            f'https://music.youtube.com/watch?v={id_}',
            YoutubeIE,
            id_)
...
class BeatBumpPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://beatbump.ml/release?id=MPREb_gTAcphH99wE',
               'playlist_count': 50,
               'info_dict': {'id': 'OLAK5uy_l1m0thk3g31NmIIz_vMIbWtyv7eZixlH0',
              ...
              {'url': 'https://beatbump.ml/artist/UC_aEa8K-EOJ3D6gOs7HcyNg',
               ...
               'info_dict': {'id': 'UC_aEa8K-EOJ3D6gOs7HcyNg',
    ...
    def _real_extract(self, url):
        id_ = self._match_id(url)
        return self.url_result(
            f'https://music.youtube.com/browse/{id_}',
            YoutubeTabIE,
            id_)
