...
class ParlerIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://parler.com/feed/df79fdba-07cc-48fe-b085-3293897520d7',
               'md5': '16e0f447bf186bb3cf64de5bbbf4d22d',
               'info_dict': {'id': 'df79fdba-07cc-48fe-b085-3293897520d7',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        ...
        data = self._download_json(
            f'https://api.parler.com/v0/public/parleys/{video_id}',
            video_id)['data']
        if data.get('link'):
