...
class TBSIE(TurnerBaseIE):
    ...
    '''
    _TESTS = [{'url': 'https://www.tbs.com/shows/american-dad/season-6/episode-12/you-debt-your-life',
               'info_dict': {'id': '984bdcd8db0cc00dc699927f2a411c8c6e0e48f3',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.tntdrama.com/shows/the-librarians-the-next-chapter/season-1/episode-10/and-going-medieval',
               'info_dict': {'id': 'e487b31b663a8001864f62fd20907782f7b8ccb8',
                             'ext': 'mp4',
              ...
              {'url': 'https://www.trutv.com/shows/the-carbonaro-effect/season-1/episode-1/got-the-bug-out',
               'info_dict': {'id': 'b457dd7458fd9e64b596355950b13a1ca799dc39',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        site, path, display_id, watch = self._match_valid_url(
            url).group('site', 'path', 'id', 'watch')
        is_live = bool(watch)
        ...
        software_statement = auth_info.get(
            'softwareStatement') or self._SITE_INFO[site][1]
