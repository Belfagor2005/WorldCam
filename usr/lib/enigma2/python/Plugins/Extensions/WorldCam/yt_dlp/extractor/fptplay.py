...
class FptplayIE(InfoExtractor):
    ...
    IE_NAME = 'fptplay'
    IE_DESC = 'fptplay.vn'
    _TESTS = [{'url': 'https://fptplay.vn/xem-video/nhan-duyen-dai-nhan-xin-dung-buoc-621a123016f369ebbde55945',
               'md5': 'ca0ee9bc63446c0c3e9a90186f7d6b33',
               'info_dict': {'id': '621a123016f369ebbde55945',
                             'ext': 'mp4',
              ...
              {'url': 'https://fptplay.vn/xem-video/ma-toi-la-dai-gia-61f3aa8a6b3b1d2e73c60eb5/tap-3',
               ...
               'info_dict': {'id': '61f3aa8a6b3b1d2e73c60eb5',
                             'ext': 'mp4',
              ...
              {'url': 'https://fptplay.vn/xem-video/lap-toi-do-giam-under-the-skin-6222d9684ec7230fa6e627a2/tap-4',
               ...
               'info_dict': {'id': '6222d9684ec7230fa6e627a2',
                             'ext': 'mp4',
    ...
    def _real_extract(self, url):
        video_id, slug_episode = self._match_valid_url(
            url).group('id', 'episode')
        webpage = self._download_webpage(
            url, video_id=video_id, fatal=False) or ''
    ...
    def get_api_with_st_token(self, video_id, episode):
        ...
        t = hashlib.md5(
            f'WEBv6Dkdsad90dasdjlALDDDS{timestamp}{path}'.encode()).hexdigest().upper()
