...
class CaracolTvPlayIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://play.caracoltv.com/videoDetails/OTo4NGFmNjUwOWQ2ZmM0NTg2YWRiOWU0MGNhOWViOWJkYQ==',
               'info_dict': {'id': 'OTo4NGFmNjUwOWQ2ZmM0NTg2YWRiOWU0MGNhOWViOWJkYQ==',
              ...
              {'url': 'https://play.caracoltv.com/videoDetails/OTo3OWM4ZTliYzQxMmM0MTMxYTk4Mjk2YjdjNGQ4NGRkOQ==/ella?season=0',
               'info_dict': {'id': 'OTo3OWM4ZTliYzQxMmM0MTMxYTk4Mjk2YjdjNGQ4NGRkOQ==',
                             'title': 'Ella',
              ...
              {'url': 'https://play.caracoltv.com/videoDetails/OTpiYTY1YTVmOTI5MzI0ZWJhOGZiY2Y3MmRlOWZlYmJkOA==/la-vuelta-al-mundo-en-80-risas-2022?season=0',
               'info_dict': {'id': 'OTpiYTY1YTVmOTI5MzI0ZWJhOGZiY2Y3MmRlOWZlYmJkOA==',
    ...
    def _perform_login(self, email, password):
        ...
        bearer_token = self._download_json(
            ...
            headers={
                'Authorization': f'Basic {app_token}'})['token']
    ...
    def _real_extract(self, url):
        ...
        api_response = self._download_json(
            ...
            headers={
                'Authorization': f'Bearer {self._USER_TOKEN}'})['items'][0]
