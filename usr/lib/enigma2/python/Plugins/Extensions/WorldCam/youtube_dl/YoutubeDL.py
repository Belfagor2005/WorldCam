...
class YoutubeDL:
    ...
    def process_info(self, info_dict):
        ...
        if annofn:
            ...
            if not self.params.get(
                    'overwrites', True) and os.path.exists(
    ...
    def print_debug_header(self):
        ...
        for plugin_type, plugins in {
                'Extractor': plugin_ies, 'Post-Processor': plugin_pps}.items():
            display_list = ['{}{}'.format(
            ...
            if plugin_type == 'Extractor':
                display_list.extend(
                    ...
                    plugins in plugin_ie_overrides.items())
            if not display_list:
                continue
            write_debug(
    ...
    def _write_thumbnails(
        ...
        for idx, t in list(enumerate(thumbnails))[::-1]:
            thumb_ext = (f'{t["id"]}.' if multiple else '') + \
                determine_ext(t['url'], 'jpg')
